...
export const Register = ({navigation}) => {
  ...
  const ShowmyRegisterData = () =>{
    alert('Your Name :' + Uname + '\n' + 'your Password is:' + Upass +  '\n' + 'Your Email is' + Uemail);
  }
  ...
  return (
    <View >
      ...
      <View style={{ width: '100%', height: '20%', backgroundColor: '#3e3e3e', flexDirection: "row", }}>
      ...
      <View style={{ width: '100%', height: '58%', backgroundColor: '#3e3e3e' }}>


        <View style={{ flexDirection: 'row', marginTop: 10 }} >
          <Text onPress={() => { navigation.navigate('Login'); }} style={{ flex: 0.2, marginLeft: 20, color: 'gray', fontSize: 18 }}>LOGIN</Text>

          <Text onPress={() => { navigation.navigate('Register'); }} style={{ flex: 0.2, color: 'white', fontSize: 16 }}>REGISTER</Text>
        </View>



        <View style={{
          backgroundColor: '#2e2c2c', color: 'white', height: 25, marginTop: 20, width: '90%', alignSelf: 'center'
        ...
        <View style={{
          backgroundColor: '#2e2c2c', color: 'white', height: 25, marginTop: 20, width: '90%', alignSelf: 'center'
        }}><Text  style={{ color: '#f84e69', fontSize: 20, paddingTop: 4, paddingLeft: 10 }}>Email</Text></View>
        ...
        <View style={{ width: '90%', height: 50, alignSelf: 'center', borderRadius: 100, backgroundColor: '#fa526c' }}>
          <Text onPress={ShowmyRegisterData} style={{ fontSize: 22, marginTop: 7, alignSelf: 'center', color:'white'  }}> Register</Text>
        </View>
        ...
        }}><Text onPress={() => { navigation.navigate('Login') }} style={{ color: 'white', fontSize: 15, alignSelf: 'center' }}>Already have an Account? Login</Text></View>
      ...
      <View style={{ width: '100%', height: '22%', backgroundColor: '#3e3e3e' }}>
